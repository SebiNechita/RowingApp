...
public class DataValidation {
    ...
    protected boolean validateData(LocalDateTime startTime, LocalDateTime endTime,
                                   String name, String description, String certificate, String authToken) throws Exception {
     ...
     */
    protected boolean validateCertificate(String certificate, String authToken) throws InvalidCertificateException {
     ...
     */
    protected boolean validateOrganisation(String organisation, String authToken) throws InvalidOrganisationException {
